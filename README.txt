...
Microsoft SQL Server 2014 Instance against
[DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) AWS RDS Microsoft
SQL Server 2014 Instance STIG Version 1 Release 9 tailored for [CMS ARS
...
for CMS systems categories as High.
...
follow these steps:
    ...
    bundle install
    cd ..
    inspec exec cms-ars-3.1-high-aws-rds-microsoft-sql-server-2014-instance-stig-overlay --attrs=<path_to_your_attributes_file/name_of_your_attributes_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json> 
...
[issue](https://github.cms.gov/ispg/cms-ars-3.1-high-aws-rds-microsoft-sql-server-2014-instance-stig-overlay/issues/new).
